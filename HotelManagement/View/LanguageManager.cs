        ...
        public static void SetLanguageDictionary(ELanguage lang)
        {
            ...
            switch (lang)
            {
                case ELanguage.English:
                    dict.Source = new Uri("..\\..\\..\\Resources\\Languages\\ResourceString.en-US.xaml",
                             UriKind.Relative);
                    oldReSource.Source = new Uri("..\\..\\..\\Resources\\Languages\\ResourceString.vi-VN.xaml",
                                   UriKind.Relative);
                    break;
                case ELanguage.VietNamese:
                    dict.Source = new Uri("..\\..\\..\\Resources\\Languages\\ResourceString.vi-VN.xaml",
                                   UriKind.Relative);
                    oldReSource.Source = new Uri("..\\..\\..\\Resources\\Languages\\ResourceString.en-US.xaml",
                             UriKind.Relative);
                    break;
                default:
